...
const BodyMenuItem = ({ imgSrc, title, description, button, url }) => {
  return (
    <NavLink to={url} className="bg-container-box flex-1 px-8 py-2 rounded-2xl border-solid border-red-50 text-center flex flex-col justify-center items-center">
